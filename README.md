...
```
cd existing_repo
git remote add origin https://gitlab.metropolia.fi/server-side-scripting-frameworks2/bookingsystem.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.metropolia.fi/server-side-scripting-frameworks2/bookingsystem/-/settings/integrations)
